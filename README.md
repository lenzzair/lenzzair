...
|    \ _______ /    |   ~ ❯ id
 \    / \   / \    /    uid=0(root)
   \/    | |    \/
         | |
Status  : BUT R&T Cybersécurité · IUT Annecy · 3ème année (alternance)
Next    : École 2600 · 2026–2029
...
|--------|-------------|-------|
| 🔧 **bootloader-kernel** | Bootloader x86 + noyau minimal — gestion mémoire, interruptions, I/O | `ASM` `C` |
